    ...
    class HasManyThroughAssociation < HasManyAssociation # :nodoc:
      ...
      private
        ...
        def through_scope_attributes
          ...
          route = through_association.reflection.association_route_for_origin(owner, through_association.reflection.klass)
          except_keys = [
            *route.link.reference.reference_key,
        ...
        def delete_records(records, method)
          ...
          when :nullify
            ...
            count = scope.update_all(route.link.reference.reference_key.index_with(nil))
          else
            count = scope.delete_all
          end
