  ...
  module AttributeMethods
    ...
    module ClassMethods
      ...
      def alias_attribute_method_definition(code_generator, pattern, new_name, old_name)
        ...
        if all_targets_are_attribute_methods
        ...
        if far_method
          ...
          if has_attribute?(far_name)
            ...
            ActiveModel.deprecator.warn(
              "#{intro}, but `#{far_target}` is not an attribute method. " \
              "In Rails 7.2, alias_attribute will no longer work with non-attribute methods; " \
