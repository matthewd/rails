...
module ActiveRecord
  module ConnectionAdapters
    class ConnectionPool
      # = Active Record Connection Pool \Sweeper
      #
      # The sweeper is a singleton that exists in the background of the process
      ...
      # XXX: s/Reaper/Sweeper/, because it's doing a bunch of things now, and
      # the old name is too specific.
      class Reaper
