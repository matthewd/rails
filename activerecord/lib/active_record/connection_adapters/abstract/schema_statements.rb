...
module ActiveRecord
  module ConnectionAdapters # :nodoc:
    module SchemaStatements
      ...
      def data_sources
        query_values(data_source_sql, "SCHEMA", materialize_transactions: false)
      ...
      def data_source_exists?(name)
        query_values(data_source_sql(name), "SCHEMA", materialize_transactions: false).any? if name.present?
      rescue NotImplementedError
      ...
      def tables
        query_values(data_source_sql(type: "BASE TABLE"), "SCHEMA", materialize_transactions: false)
      end
      ...
      def table_exists?(table_name)
        query_values(data_source_sql(table_name, type: "BASE TABLE"), "SCHEMA", materialize_transactions: false).any? if table_name.present?
      rescue NotImplementedError
      ...
      def views
        query_values(data_source_sql(type: "VIEW"), "SCHEMA", materialize_transactions: false)
      end
      ...
      def view_exists?(view_name)
        query_values(data_source_sql(view_name, type: "VIEW"), "SCHEMA", materialize_transactions: false).any? if view_name.present?
      rescue NotImplementedError
