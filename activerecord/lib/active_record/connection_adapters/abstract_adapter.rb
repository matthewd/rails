...
module ActiveRecord
  module ConnectionAdapters # :nodoc:
    ...
    class AbstractAdapter
      ...
      # Consume from +budget+ if +exception+ warrants another attempt. True means
      # re-enter readiness-then-execute: backoff is paid here, and a connection
      # error's reconnect is already scheduled for ensure_connection_ready.
