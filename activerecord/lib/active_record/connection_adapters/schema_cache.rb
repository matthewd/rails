...
module ActiveRecord
  module ConnectionAdapters
          ...
          if self.class.check_schema_cache_dump_version
            begin
              ...
              if new_cache.version(connection) != current_version
                warn "Ignoring #{@cache_path} because it has expired. The current schema version is #{current_version}, but the one in the schema cache file is #{cache.version}."
                return
              end
    ...
    class SchemaCache
      ...
      # XXX deprecate data_sources: :data_source_exists?
